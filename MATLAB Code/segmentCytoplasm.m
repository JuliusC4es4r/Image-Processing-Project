function cytoplasmMask = segmentCytoplasm(EDF_image, nucleusMask,segmentedClumps, W, alpha, beta)
% EDF_image = input image
% nucleusMask = nucleus mask generated by segment nuclei
% segmentedClumps = segmented clump mask generated by segment clumps
% W = width of square grid overlayed on each nuclei
% alpha = likelihood multiplier of grid squares belonging to same cell
% beta = allowed degree of overlap between cells in a cell clump

% this function implements part of the cytoplasm segmentation algorithm from the
...
% Miguel Manguerra and Kimiya Mousavi
    ...
    for i = 1:length(true_centroids_x)
        ...
        % draw square associated with nuclei on image
