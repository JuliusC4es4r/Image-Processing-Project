...
% area = minimum area of clump

% this function implements a modified version of the clump segmentation algorithm from the
...
% Miguel Manguerra and Kimiya Mousavi
    ...
    % finding threshold T and converting to uint8 threshold
    T = graythresh(imageSample);
    T = T * 255;

    imageSample = double(imageSample);

    % initializing binarized image
